...
if __name__ == "__main__":
    ...
    boxplot = sns.boxplot(x='model', y='r2_weights', hue='model', data=df_combined, ax=ax, palette={"Taylor": "darkorange", "MLP": "forestgreen"}, fliersize=0, width=0.5)
    for patch in boxplot.artists:
        r, g, b, a = patch.get_facecolor()
        patch.set_facecolor((r, g, b, .3))

    sns.stripplot(x='model', y='r2_weights', hue='model', data=df_combined, ax=ax, palette={"Taylor": "darkorange", "MLP": "forestgreen"}, legend=False, size=6, edgecolor='w', linewidth=1, jitter=True, zorder=2)

    ax.set_xlabel('', fontsize=20)
    ax.set_ylabel('', fontsize=20)  # Remove y-axis label
    ax.set_title(r'$R^2$ Weights', fontsize=25, fontweight='bold')  # Set title instead
    ...
    plt.savefig("plotters/neurips24/imgs/fig3b.svg", dpi=600)
    plt.close(fig)
    print("saved fig!")
